#!/usr/bin/env python
"""
Visualize the spatial distribution of selected episodes from random sampling.

Reads selected episode indices from random_112_seed42.json,
extracts initial object positions (xyz) from each episode,
and plots a 2D or 3D scatter plot saved as see_random_112.png.
"""
import json
import sys
...
SUBSET_FILE = "/data/zhonglinye/jun/lerobot/personal/work2/duibi/random_42/subsets/random_112_seed42.json"
OUTPUT_IMAGE = str(Path(__file__).parent / "see_random_112.png")
...
def main():
    ...
    if z_is_constant:
        ...
        ax.set_title(f"Random Sampling: 112 Episodes in Workspace (Z={z_vals[0]:.3f})", fontsize=14)
        ax.set_aspect("equal")
        ...
        ax.set_title("Random Sampling: 112 Episodes in 3D Workspace", fontsize=14)
