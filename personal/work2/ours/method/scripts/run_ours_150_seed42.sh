#!/bin/bash
# Train with SIC-selected subset (N=150, seed=42)
# tmux new -s train_ours_150
# conda activate lb_server
# bash /data/zhonglinye/jun/lerobot/personal/work2/ours/method/scripts/run_ours_150_seed42.sh 0
set -e
