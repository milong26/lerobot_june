#!/bin/bash
# GPU监控脚本：4小时后开始检查GPU 0显存，满足条件后自动启动random训练任务
# 使用方法: bash monitor_gpu_and_launch_random.sh
...
LAUNCH_SCRIPT="personal/work2/duibi/train_and_eval_scripts/launch_random.sh"
LAUNCH_ARGS="42 1 pick_place-v3_corner"
...
LOG_FILE="$LOG_DIR/monitor_random_${TIMESTAMP}.log"
