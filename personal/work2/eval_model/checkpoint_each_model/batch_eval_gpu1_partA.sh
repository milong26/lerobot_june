...
MODELS_PART_A=(
    "ours_112_seed42_corner/dynamicanchor_112_seed42"
    "ours_112_seed42_corner2/dynamicanchor_112_seed42"
    "ours_112_seed42_corner3/dynamicanchor_112_seed42"
    "ours_v2_112_seed42_corner/dynamicanchor_v2_112_seed42"
    "ours_v2_112_seed42_corner3/dynamicanchor_v2_112_seed42"
    "ours_v3_no_action_112_seed42_corner/dynamicanchor_v3_no_action_112_seed42"
    "ours_v4_112_seed42_corner/dynamicgrid_v4_112_seed42"
)
...
echo "============================================================"
echo "MetaWorld Checkpoint Sweep - GPU ${GPU_ID} (Part A)"
echo "============================================================"
...
for MODEL_REL in "${MODELS_PART_A[@]}"; do
...
echo "[DISCOVER] Found ${TOTAL_TASKS} tasks for Part A"

if [[ "${TOTAL_TASKS}" -eq 0 ]]; then
    echo "[INFO] No tasks for Part A. Exiting."
    rm -f "${PID_FILE}"
    exit 0
fi
...
echo "============================================================"
echo "GPU${GPU_ID} PartA FINISHED"
echo "============================================================"
