#!/bin/bash
# GPU监控脚本：2小时后开始检查GPU 0显存，满足条件后自动启动训练任务
# 使用方法: bash monitor_gpu_grid_uniform.sh
...
LAUNCH_SCRIPT="personal/work2/duibi/train_and_eval_scripts/launch_grid_uniform.sh"
LAUNCH_ARGS="0 pick_place-v3_corner"
...
LOG_FILE="$LOG_DIR/monitor_grid_uniform_${TIMESTAMP}.log"
