#!/bin/bash
# GPU监控脚本：6小时后开始检查GPU 0显存，满足条件后自动启动TinyVLA-S训练任务
# 使用方法: bash monitor_gpu_and_launch_tinyvla_s.sh
...
LAUNCH_ARGS="tinyvla-s --dataset disassemble-v3_corner --gpu 0 --num_episodes 112"
...
LOG_FILE="$LOG_DIR/monitor_tinyvla_s_${TIMESTAMP}.log"
