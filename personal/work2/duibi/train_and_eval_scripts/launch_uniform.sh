#!/bin/bash
# Launch uniform experiment in tmux
# Usage: bash launch_uniform.sh <gpu_id> <dataset_name>
...
OUTPUT_BASE_DIR="/data/zhonglinye/jun/lerobot/personal/work2/duibi/uniform_42_${DATASET_NAME}"
LOG_DIR="$OUTPUT_BASE_DIR/logs"
EXP_NAME="uniform_112_seed42"
TMUX_SESSION="uniform_112_s42_${DATASET_NAME}"
...
bash "\$TRAIN_SCRIPT" uniform 112 42 \$GPU_ID "\$OUTPUT_BASE_DIR" "\$DATASET_NAME" 2>&1 | tee -a "\$LOG_DIR/\$EXP_NAME.log"
