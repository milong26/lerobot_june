...
# Usage: bash launch_uniform.sh <gpu_id>

set -e

GPU_ID=${1:-0}
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
OUTPUT_BASE_DIR="/data/zhonglinye/jun/lerobot/personal/work2/duibi/uniform_42"
LOG_DIR="$OUTPUT_BASE_DIR/logs"
EXP_NAME="uniform_112_seed42"
TMUX_SESSION="uniform_112_s42"
...
bash "$TRAIN_SCRIPT" uniform 112 42 $GPU_ID "$OUTPUT_BASE_DIR" 2>&1 | tee -a "$LOG_DIR/$EXP_NAME.log"
