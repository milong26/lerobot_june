...
# Usage: bash launch_deminf.sh <num_episodes> <gpu_id> [seed] [dataset_name]
...
# DemInf: use pre-computed subset directly
bash "\$TRAIN_SCRIPT" deminf \$NUM_EPISODES \$SEED \$GPU_ID "\$OUTPUT_BASE_DIR" "\$DATASET_NAME" 2>&1 | tee -a "\$LOG_DIR/\$EXP_NAME.log"
