#!/bin/bash
# 后台启动GPU监控脚本的便捷工具（TinyVLA任务）
# 使用方法: bash order_tinyvla.sh

WORK_DIR="/data/zhonglinye/jun/lerobot"
MONITOR_SCRIPT="$WORK_DIR/personal/work2/monitor_gpu_tinyvla.sh"
LOG_DIR="$WORK_DIR/personal/work2/gpu_monitor_logs"
ORDER_LOG="$LOG_DIR/order_tinyvla_$(date '+%Y%m%d_%H%M%S').log"

mkdir -p "$LOG_DIR"

echo "========================================="
echo "GPU监控脚本 - order_tinyvla"
echo "========================================="
echo ""
