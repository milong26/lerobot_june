#!/bin/bash
# Our-V7 end-to-end pipeline: paper-faithful causal selection on three MetaWorld
# datasets, merge selected episodes, then jointly train SmolVLA.
#
# Usage:
...
PYCHECK
    ...
    if [[ "$REUSE_SELECTION" == true ]]; then
        ...
        echo "=== V7 selecting $DATASET_NAME ==="
        rm -f "$SELECTION_FILE"
...
echo ""
echo "=== Training SmolVLA on merged Our-V7 dataset ==="
lerobot-train \
