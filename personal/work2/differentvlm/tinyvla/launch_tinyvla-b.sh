#!/bin/bash
# Launch TinyVLA-B training experiment in tmux
# Usage: bash launch_tinyvla-b.sh --gpu-id <id> --num-episodes <num> --dataset-name <name> --method <method> [--seed <seed>]
#
# Supported methods:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Usage: bash launch_tinyvla-b.sh --gpu-id <id> --num-episodes <num> --dataset-name <name> --method <method> [--seed <seed>]"
            exit 1
            ;;
    esac
done
