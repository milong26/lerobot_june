"""
Visual Embedding Module for V6
...
Directly reused from V4 without modification.
"""
...
from our_v6.config import PCA_DIM, VISUAL_NORMALIZE, VISUAL_GLOBAL_WEIGHT, VISUAL_WRIST_WEIGHT
