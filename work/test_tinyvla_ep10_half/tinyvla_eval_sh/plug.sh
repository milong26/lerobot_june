...
# ============================================================
# SmolVLA 测试脚本：plug
# 功能：运行 SmolVLA 模型推理，执行 plug 相关任务
# ============================================================

# 运行方式：
# 1. 先赋予执行权限（仅首次需要）：
#    chmod +x /home/qwe/jun/lerobot/work/test_tinyvla_ep10_half/tinyvla_eval_sh/plug.sh
#
# 2. 直接运行：
#    ./plug.sh
#    或者：
#    bash /home/qwe/jun/lerobot/work/test_tinyvla_ep10_half/tinyvla_eval_sh/plug.sh
#
...
/home/qwe/anaconda3/envs/lb_local/bin/python -m lerobot.async_inference.robot_client \
    ...
    --task="Grab the cylindrical part with a wider head" \
