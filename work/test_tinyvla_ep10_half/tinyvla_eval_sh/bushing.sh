...
# ============================================================
# SmolVLA 测试脚本：bushing
# 功能：运行 SmolVLA 模型推理，执行 bushing 相关任务
# ============================================================

# 运行方式：
# 1. 先赋予执行权限（仅首次需要）：
#    chmod +x /home/qwe/jun/lerobot/work/test_tinyvla_ep10_half/tinyvla_eval_sh/bushing.sh
#
# 2. 直接运行：
#    ./bushing.sh
#    或者：
#    bash /home/qwe/jun/lerobot/work/test_tinyvla_ep10_half/tinyvla_eval_sh/bushing.sh
#
