...
# ============================================================
# SmolVLA 测试脚本：charger
# 功能：运行 SmolVLA 模型推理，执行 charger 相关任务
# ============================================================

# 运行方式：
# 1. 先赋予执行权限（仅首次需要）：
#    chmod +x /home/qwe/jun/lerobot/work/test_smolvla_ep10_half/smolvla_eval_sh/charger.sh
#
# 2. 直接运行：
#    ./charger.sh
#    或者：
#    bash /home/qwe/jun/lerobot/work/test_smolvla_ep10_half/smolvla_eval_sh/charger.sh
#
...
/home/qwe/anaconda3/envs/lb_local/bin/python -m lerobot.async_inference.robot_client \
    ...
    --task="Grab the rectangular charger" \
