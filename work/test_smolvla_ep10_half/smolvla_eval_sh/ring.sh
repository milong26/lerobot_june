...
# 运行方式：
# 1. 先赋予执行权限（仅首次需要）：
#    chmod +x /home/qwe/jun/lerobot/work/test_smolvla_ep10_half/smolvla_eval_sh/ring.sh
#
# 2. 直接运行：
#    ./ring.sh
#    或者：
#    bash /home/qwe/jun/lerobot/work/test_smolvla_ep10_half/smolvla_eval_sh/ring.sh
#
