...
# 运行方式：
# 1. 先赋予执行权限（仅首次需要）：
#    chmod +x /home/qwe/jun/lerobot/work/test_evo1_ep10_half/eval_sh/cylinder_lay.sh
#
# 2. 直接运行：
#    ./cylinder_lay.sh
#    或者：
#    bash /home/qwe/jun/lerobot/work/test_evo1_ep10_half/eval_sh/cylinder_lay.sh
#
