...
def decode_image_from_list(img_list):
    ...
    img = cv2.resize(img_array, (320, 240))
...
def infer_from_json_dict(data: dict, model, normalizer):
    ...
    for img in images:
        assert img.shape == (3, 320, 240), "image_size must be (3,448,448)"
    ...
    try:
        async for message in websocket:
            ...
            try:
                ...
                print(f"ERROR in infer_from_json_dict: {e}")
                import traceback
                traceback.print_exc()
...
if __name__ == "__main__":
    ckpt_dir = "./Evo1_OWN_stage2/step_best/"
