...
# ============================================================
# 测试脚本：bushing
# 功能：运行 test_half_resolution 主控制循环，执行 bushing 相关任务
# ============================================================

# 运行方式：
# 1. 先赋予执行权限（仅首次需要）：
#    chmod +x /home/qwe/jun/lerobot/work/test_half_resolution/eval_sh/bushing.sh
#
# 2. 直接运行：
#    ./bushing.sh
#    或者：
#    bash /home/qwe/jun/lerobot/work/test_half_resolution/eval_sh/bushing.sh
#
