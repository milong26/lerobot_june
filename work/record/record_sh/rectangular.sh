...
# 运行方式：
# 1. 先赋予执行权限（仅首次需要）：
#    chmod +x /home/qwe/jun/lerobot/work/test_rollback/record_sh/rectangular.sh
#
# 2. 直接运行：
#    ./rectangular.sh
#    或者：
#    bash /home/qwe/jun/lerobot/work/test_rollback/record_sh/rectangular.sh
#
...
lerobot-record \
    ...
    --dataset.repo_id=ep10/rectangular \
    --dataset.num_episodes=10 \
    --dataset.single_task="Grab the rectangular object" \
    --dataset.streaming_encoding=true \
    --dataset.root=/home/qwe/.cache/huggingface/lerobot/ep10/rectangular \
