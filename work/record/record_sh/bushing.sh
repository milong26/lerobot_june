...
# 运行方式：
# 1. 先赋予执行权限（仅首次需要）：
#    chmod +x /home/qwe/jun/lerobot/work/test_rollback/record_sh/bushing.sh
#
# 2. 直接运行：
#    ./bushing.sh
#    或者：
#    bash /home/qwe/jun/lerobot/work/test_rollback/record_sh/bushing.sh
#
...
lerobot-record \
    ...
    --dataset.single_task="Grab the cylindrical rubber part with two raised circular rims." \
    --dataset.streaming_encoding=true \
    --dataset.root=/home/qwe/.cache/huggingface/lerobot/ep10/bushing \
