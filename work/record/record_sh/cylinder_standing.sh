...
# 运行方式：
# 1. 先赋予执行权限（仅首次需要）：
#    chmod +x /home/qwe/jun/lerobot/work/test_rollback/record_sh/cylinder_standing.sh
#
# 2. 直接运行：
#    ./cylinder_standing.sh
#    或者：
#    bash /home/qwe/jun/lerobot/work/test_rollback/record_sh/cylinder_standing.sh
#
